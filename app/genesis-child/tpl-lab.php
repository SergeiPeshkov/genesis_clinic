                                ...
                                <div class="service-tab service-tab_root">
                                    ...
                                    <?php $terms = get_terms( [
                                        ...
                                        foreach ($terms as $key => $value) { ?>
											...
											<div class="service-tab service-tab__service-single" onClick="goto_to_analis();" data-action-id="<?php echo $value->term_id; ?>">
												
													<i style="color: <?php the_field('иконка', 'analizi_cat_'.$value->term_id); ?>" class="icon-lab"></i> 
													<?php echo $value->name; ?>
