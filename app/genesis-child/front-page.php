            ...
            <div class="clearfix">
				...
				<!--================================== карусель с новостями =============================================== -->
					<div id="oc-portfolio" class="owl-carousel portfolio-carousel carousel-widget owl-loaded owl-drag"
							data-margin="0" data-nav="true" data-pagi="true" data-items-xs="1" data-items-sm="1"
							...
							<div class="owl-stage-outer">
									...
									<?php foreach ($news_list as $news_item) {
											...
											//$news_excerpt = wp_trim_words(get_the_excerpt($news_item), 10, '...' );
                                            $news_excerpt = trim_chars($news_item, 200, '...');
?>											
										<div class="owl-item">
												<div class="oc-item">
