                    ...
                    <div class="b-links block shadow">
                        ...
                        <ul>
                            <?php
                                ...
                                $news = get_posts(array('post_type' => 'news', 'showposts' => $in_blocks['news_num'], 'meta_key' => 'direction', 'meta_value' => get_post_meta($post->ID, 'parentem', 1)));
                                foreach ($news as $n) { 
                            ?>
                        ...
                        <div class="content">
                            ...
                            <div class="b-video block">
                                ...
                                <a href="<?=$video?>" class="player shadow fancybox-media">
                                    <?php MultiPostThumbnails::the_post_thumbnail('specialisation', 'video-thumb-s', null, 'thumb-drctn-video'); ?>
                                </a>
                            </div>
                            <!-- /.b-video block -->
                            <?php } ?>
