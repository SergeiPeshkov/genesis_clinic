...
class sg_subscribe {
	...
	function db_upgrade_check () {
		...
		// add the options
		add_option('sg_subscribe_settings', array('use_custom_style' => '', 'email' => get_bloginfo('admin_email'), 'name' => get_bloginfo('name'), 'header' => '[theme_path]/header.php', 'sidebar' => '', 'footer' => '[theme_path]/footer.php', 'before_manager' => '<div id="content" class="widecolumn subscription-manager">', 'after_manager' => '</div>', 'not_subscribed_text' => 'Уведомлять по e-mail при появлении новых комментариев', 'subscribed_text' => '', 'author_text' => '', 'version' => $this->version));
